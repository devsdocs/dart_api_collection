...
class RemoteUploadList {
  ...
  factory RemoteUploadList.fromJson(String str) =>
      RemoteUploadList.fromMap(json.decode(str));

  factory RemoteUploadList.fromMap(Map<String, dynamic> json) =>
      RemoteUploadList(
        msg: json['msg'],
